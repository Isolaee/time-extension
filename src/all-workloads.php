...
/**
 * Render the "All Workloads" admin page.
 * This file now defines the page callback so it can be registered from
 * the central plugin bootstrap (`WP_SQL_workloads-main.php`).
 */
